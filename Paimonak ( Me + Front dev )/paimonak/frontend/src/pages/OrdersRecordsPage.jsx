export default function OrdersRecordsPage() {
  return (
    ...
    <div className="w-80 h-cart bg-white rounded-3xl m-auto mt-14 pt-20">
      ...
      <h2 className="text-center font-bold text-xl -mt-4"> سوابق سفارش</h2>

      <div className="px-3 flex flex-row mt-4">
        <p className="text-sm m-auto mr-3">Blessing of the welkin moon</p>
        <span className="flex m-auto">
          <p className="px-2 text-lg font-semibold -ml-4">#001</p>
        </span>
      </div>
      ...
      <div className="px-3 flex flex-row mt-4">
        <p className="text-sm m-auto mr-3">Blessing of the welkin moon</p>
        <span className="flex m-auto">
        <p className="px-2 text-lg font-semibold -ml-4">#002</p>
        </span>
      </div>
      <div className="px-6 flex mt-1">
      <p className="text-xs m-auto mr-0">آیدی(uid):123123123</p>
      ...
      <div className="px-3 flex flex-row mt-4">
        <p className="text-sm m-auto mr-3">Blessing of the welkin moon</p>
        <span className="flex m-auto">
        <p className="px-2 text-lg font-semibold -ml-4">#003</p>
        </span>
      </div>
      <div className="px-6 flex mt-1">
      <p className="text-xs m-auto mr-0">آیدی(uid):123123123</p>
      ...
      <div className="px-3 flex flex-row mt-4">
        <p className="text-sm m-auto mr-3">Blessing of the welkin moon</p>
        <span className="flex m-auto">
        <p className="px-2 text-lg font-semibold -ml-4">#004</p>
        </span>
      </div>
      <div className="px-6 flex mt-1">
      <p className="text-xs m-auto mr-0">آیدی(uid):123123123</p>
